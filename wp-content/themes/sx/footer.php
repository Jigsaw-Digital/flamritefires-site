        ...
        <div class="max-w-7xl mx-auto lg:flex justify-between px-6 lg:px-0">
            ...
            <div class="flex flex-wrap gap-12 mt-8 lg:mt-0">
                ...
                <div class="space-y-2">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/flameritefiresltd" target="_blank" rel="noopener" class="lg:px-4 text-sm uppercase tracking-[6px] text-white hover:text-white/70 flex items-center gap-2 block">
                    ...
                    <!-- Twitter -->
                    <a href="https://twitter.com/FlameriteFires" target="_blank" rel="noopener" class="lg:px-4 text-sm uppercase tracking-[6px] text-white hover:text-white/70 flex items-center gap-2 block">
                        <span class="w-6 h-6 inline-flex items-center justify-center">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/flameritefires/" target="_blank" rel="noopener" class="lg:px-4 text-sm uppercase tracking-[6px] text-white hover:text-white/70 flex items-center gap-2 block">
                        <span class="w-6 h-6 inline-flex items-center justify-center">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Pinterest -->
                    <a href="https://www.pinterest.co.uk/Flameritefires/" target="_blank" rel="noopener" class="lg:px-4 text-sm uppercase tracking-[6px] text-white hover:text-white/70 flex items-center gap-2 block">
                        <span class="w-6 h-6 inline-flex items-center justify-center">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- YouTube -->
                    <a href="https://www.youtube.com/channel/UCuBluN5KsWR_1ABRY0BoL7w" target="_blank" rel="noopener" class="lg:px-4 text-sm uppercase tracking-[6px] text-white hover:text-white/70 flex items-center gap-2 block">
                        <span class="w-6 h-6 inline-flex items-center justify-center">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- LinkedIn -->
                    <a href="https://www.linkedin.com/company/flamerite-fires-limited/" target="_blank" rel="noopener" class="lg:px-4 text-sm uppercase tracking-[6px] text-white hover:text-white/70 flex items-center gap-2 block">
                        <span class="w-6 h-6 inline-flex items-center justify-center">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
