        ...
        function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
            ...
            if ($depth === 0) {
                ...
                if ($has_children) {
                    ...
                    $output .= '<span class="px-2 text-sm uppercase tracking-[2px] relative text-white hover:text-white/70 inline-block" style="font-size: 13px;">';
                    $output .= apply_filters('the_title', $item->title, $item->ID);
                    $output .= '</span>'; 
                } else {
                    $output .= $indent . '<li>';
                    $output .= '<a href="' . esc_url($atts['href']) . '" class="px-2 text-sm uppercase tracking-[2px] relative text-white hover:text-white/70" style="font-size: 13px;">';
                    $output .= apply_filters('the_title', $item->title, $item->ID);
                    $output .= '</a>';
                }
            } else {
