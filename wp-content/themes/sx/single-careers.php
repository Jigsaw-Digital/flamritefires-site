        ...
        <div class="text-center max-w-4xl mx-auto">
            <div class="hero-title" data-animation="fadeUp">
                ...
                <div class="flex items-center justify-center gap-6 text-sm text-gray-200 flex-wrap">
                    <?php if ($job_location) : ?>
                        <div class="row-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor"><use href="<?php echo get_template_directory_uri(); ?>/assets/images/icons.svg#icon-location"/></svg>
                            <?php echo esc_html($job_location); ?>
                        </div>
                    <?php endif; ?>
                    <div class="row-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor"><use href="<?php echo get_template_directory_uri(); ?>/assets/images/icons.svg#icon-briefcase"/></svg>
                        <?php echo esc_html($type_label); ?>
                    </div>
                    <?php if ($department) : ?>
                        <div class="row-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor"><use href="<?php echo get_template_directory_uri(); ?>/assets/images/icons.svg#icon-building"/></svg>
